 ...
 */
reason: string | null, } } | { "type": "workerQuestion", "payload": { runId: RunId, taskId: TaskId, workerId: WorkerId, question: string | null, } } | { "type": "escalationRaised", "payload": { runId: RunId, taskId: TaskId, workerId: WorkerId, reason: string, question: string | null, } } | { "type": "escalationAnswered", "payload": { runId: RunId, taskId: TaskId, workerId: WorkerId, answeredBy: AnsweredBy, answer: string | null, } } | { "type": "budgetExceeded", "payload": { runId: RunId, taskId: TaskId, workerId: WorkerId, turnsUsed: number, turnLimit: number, } } | { "type": "workerTimeout", "payload": { runId: RunId, taskId: TaskId, workerId: WorkerId, kind: TimeoutKind, sinceMs: number, } };
