...
// ----------------------------- worker-supplied text is content
...
/// `INSERT INTO messages` whose redaction gap was already closed at
/// `message/send`. Read back through `message/list`, the path a consumer
/// uses.
#[tokio::test]
